...
- But really we know all the front-end frameworks have similar component-based concepts, and back-ends have similar concepts as each other regardless of which framework and programming language, so use whichever one you know to demonstrate your understanding and skills.
